...
export const getSvg = (info: SvgInfo): string => {
  ...
  return `
    ...
    <rect data-testid="card-bg" x="0.5" y="0.5" rx="4.5" height="99%" stroke="${background}" width="494" fill=${background} stroke-opacity="1" />
    <g data-testid="card-title" transform="translate(25, 35)">
      <g transform="translate(0, 0)">
        <text x="0" y="0" class="header" data-testid="header">${username}'s LeetCode Stats</text>
      </g>
    </g>
    <g data-testid="main-card-body" transform="translate(0, 55)">
      <g data-testid="acceptance-circle" transform="translate(400, 47.5)">
      ...
      <svg x="0" y="0">
        <g transform="translate(0, 0)">
          <g class="stagger" style="animation-delay: 450ms" transform="translate(25, 0)">
            ...
            <text class="stat" x="200" y="12.5" data-testid="contribs">${ranking}</text>
          </g>
        </g>
        <g transform="translate(0, 25)">
          <g class="stagger" style="animation-delay: 600ms" transform="translate(25, 0)">
            <text class="stat bold" y="12.5">Total Questions Solved:</text>
            <text class="stat" x="200" y="12.5" data-testid="stars">${totalSolved}/${totalQuestions}</text>
          </g>
        </g>
        <g transform="translate(0, 50)">
          <g class="stagger" style="animation-delay: 750ms" transform="translate(25, 0)">
            <text class="stat bold easy" y="12.5">Easy Questions Solved:</text>
            <text class="stat easy" x="200" y="12.5" data-testid="commits">${easySolved}/${totalEasy}</text>
          </g>
        </g>
        <g transform="translate(0, 75)">
          <g class="stagger" style="animation-delay: 900ms" transform="translate(25, 0)">
            <text class="stat bold medium" y="12.5">Medium Questions Solved:</text>
            <text class="stat medium" x="200" y="12.5" data-testid="prs">${mediumSolved}/${totalMedium}</text>
          </g>
        </g>
        <g transform="translate(0, 100)">
          <g class="stagger" style="animation-delay: 1050ms" transform="translate(25, 0)">
            <text class="stat bold hard" y="12.5">Hard Questions Solved:</text>
            <text class="stat hard" x="200" y="12.5" data-testid="issues">${hardSolved}/${totalHard}</text>
          </g>
        </g>
      </svg>
    </g>
